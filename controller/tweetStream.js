...
function TweetStream () {
	...
	*/
	function streamTweets() {
		...
		var stream = twit.stream('statuses/filter', { locations: [geoSettings.stream.sw.long, geoSettings.stream.sw.lat, geoSettings.stream.ne.long, geoSettings.stream.ne.lat]})
