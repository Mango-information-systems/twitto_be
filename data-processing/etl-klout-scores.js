...
//console.log(ids[currentIndex].klout_id)
			if (err || klout_response.validationErrors) {
				if (err == 'Error: Klout is unavailable.' || err == 'SyntaxError: Unexpected end of input' || err == 'Error: Klout is down or being upgraded.' || err == 'Error: Klout internal server error.')	{
