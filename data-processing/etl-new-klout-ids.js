// extraction of klout ids for new users
...
// get user ids missing klout information
	...
	mysql.query('select tw_id from tw_user where klout_id is null and last_update_klout is null limit 5000', function(err, res) {
		if (err) throw err
		else {
			if (res.length == 0) {
