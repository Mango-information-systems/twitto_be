...
;(function( $ ){
	...
	DataTable.prototype = {
			...
			if(o.sectionHeader) {
				...
				if(!this.$toolbar_container) {
					this.$toolbar_container = $("<div></div>")
						.addClass('dt-toolbar-container clearfix hidden')
				}
				$e.prepend(
		...
		, details: function () {
			...
			$('<div class="pull-left"><p>Showing ' + start + ' to ' + end + ' of ' + o.totalRows + ' twittos</p></div>')
		...
		, pagination: function () {
			...
			if(!this.$pagination) {
				...
				var $pager = $("<ul></ul>")
					, $first = $("<li></li>").append(
						$("<a></a>")
							.attr("href", "#page=1"+"&perpage="+(parseInt(o.perPage)))
							.data("pagepage", 1)
							.html("&larr; First")
							.click(function() {
								o.currentPage = 1
								that.render();
								window.location.hash = "#page="+(parseInt(o.currentPage))+"&perpage="+(parseInt(o.perPage));
								$("html, body").animate({ scrollTop: $('#scrolltop').position().top - 50 });
								return false;
							})
					)
					, $previous = $("<li></li>").append(
						$("<a></a>")
							.attr("href", "#page=" + (parseInt(o.currentPage) - 1)+"&perpage="+(parseInt(o.perPage)))
					...
					, $last = $("<li></li>").append(
						$("<a></a>")
							.attr("href", "#page=" + (parseInt(o.pageCount))+"&perpage="+(parseInt(o.perPage)))
				...
				for(var i = start; i <= end; i++) {
					var $link = $("<li></li>")
						.append(
							$("<a></a>")
								.attr("href", "#page=" + (parseInt(i))+"&perpage="+(parseInt(o.perPage)))
								.data("page", i)
								.text(i)
								.click(function() {
	...
	function _initPerPage() {
		...
		var $perpage_select = $("<a></a>")
			...
			.attr("title", "Change the number of twittos per page.")
